...
IDE-FILE-RESOLUTION:
  ...
  - root: /home/tei952/sayama/03.workflow/ai-science/AI-Scientist-v2/bmad/aisg
  - Dependencies map to {root}/{type}/{name}
  - type=folder (tasks|templates|checklists|data|utils|etc...), name=file-name
  - Example: create-doc.md → /home/tei952/sayama/03.workflow/ai-science/AI-Scientist-v2/bmad/aisg/tasks/create-doc.md
